...
Скринкаст/скриншоты демонстрации — в папке [`docs/`](docs/):

- `docs/notify-demo.mp4` (или `.gif`) — экранная запись: добавление клиента на живом
  сайте и приходящее сообщение в Telegram.
- `docs/telegram-notify.png` — скриншот самого уведомления в Telegram.
